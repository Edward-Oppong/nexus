  ...
  const facets: FeatureFacet[] = [
    {
      ...
      body: 'Consult teams lose significant time moving between clinical notes, PACS imaging viewers, microbiology reports, and outpatient records. Nexus brings these sources into a single organized workspace arranged around the patient’s active clinical problem.',
      points: [
        'Integrated timeline aligning microbiology, vital sign trends, and imaging',
        'Direct DICOM and laboratory preview without opening external viewers',
      ...
      graphicData: [
        ...
        { label: 'Imaging integration', value: 'DICOM study inline preview', detail: 'Transesophageal echo linked' },
